...
from lawking.wrapper.mario_util import FaKeSubprocVecEnv
...
if FLAGS.local:
    from lawking.wrapper.mario_util import make_env_local as make_env
else:
    from lawking.wrapper.mario_util import make_env as make_env
